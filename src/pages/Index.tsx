        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div className="hidden md:flex" style={{ alignItems: "center", gap: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <a href="https://max.ru/+79622674779" target="_blank" rel="noopener noreferrer" title="MAX" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 32, height: 32, borderRadius: "50%", background: "rgba(255,255,255,0.08)", transition: "background 0.2s", fontFamily: "'Oswald', sans-serif", fontWeight: 700, color: "#fff", fontSize: 11, textDecoration: "none" }}
